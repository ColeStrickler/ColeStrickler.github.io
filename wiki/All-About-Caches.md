...
2. Fully Associative --> A block/line can be placed anywhere within the cache
3. Direct Mapped --> A set associative cache with only one block per set, a block can only go in one 							 location
